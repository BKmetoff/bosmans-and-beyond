export const COPY = {
	headerLinks: ['Mission', 'About', 'Video', 'Contact'],
	video: {
	...
	people: {
		natalia: {
			...
			bio:
				"The Polish violinist Natalia Szmydt has won multiple awards and scholarships during her education and career. She graduated from the Conservatorium van Amsterdam with a master's degree where she also took a part in the Netherlands Philharmonic Orchestra Academy and Netherlands Chamber Music Orchestra. For the last years, Natalia performed mostly as a violinist in Artem Trio – a promising and successful piano trio with growing recognition. Natalia has performed in the biggest halls in Europe;  Concertgebouw, Muziekgebouw, and De Doelen in the Netherlands,  Pau Casals in Spain, and Baltic Philharmonic in Poland. She worked with highly recognized musicians such as Agata Szymczewska, Marc Albrecht, Yuzuko Horigome, Anna Fedorova, Simone Lamsma, and many more.",
		},
		elisaveta: {
	...
	text: {
		...
		mission:
			'Our ever-changing world is reflected in music and art. Gender and race are one of the many important topics in our society today and we wish to be a part of the change. Our patron, Henriëtte Bosmans was celebrated for being one of the most successful pianists and composers in the Netherlands during her lifetime. We are fascinated by her life story; the difficulties she faced being part Jewish during the WWII and her struggle to gain recognition as a female composer. Unfortunately, today she is rarely performed, therefore we would like to honour her talent and dedication by performing her music.',
	},
}
